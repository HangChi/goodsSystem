...
<form class="layui-form" action="/goodsSystem/seller/update.do">
  <div class="layui-form-item" style="width:500px">
    <label class="layui-form-label">卖家编号</label>
    <div class="layui-input-block">
      <input type="text" name="sellerId" required  lay-verify="required" placeholder="请输入要修改的卖家编号" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
	...
	<%--修改信息展示 --%>
	<%
		String sellerUpdateTip = (String)request.getAttribute("sellerUpdateTip");
		if(sellerUpdateTip != null){
	%>
		<h6 style="color:red"><%=sellerUpdateTip %></h6>
