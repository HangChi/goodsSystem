...
<form class="layui-form" action="/goodsSystem/delivery/update.do">
  <div class="layui-form-item" style="width:500px">
    <label class="layui-form-label">物流编号</label>
    <div class="layui-input-block">
      <input type="text" name="deliveryId" required  lay-verify="required" placeholder="请输入要修改的物流编号" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
	...
	<%--添加信息展示 --%>
	<%
		String deliveryUpdateTip = (String)request.getAttribute("deliveryUpdateTip");
		if(deliveryUpdateTip != null){
	%>
		<h6 style="color:red"><%=deliveryUpdateTip %></h6>
