...
<body>
<form class="layui-form" action="/goodsSystem/goods/add.do">
  ...
  <div class="layui-input-block">
    ...
    <div class="layui-input-block">
      <input type="text" name="goodsPrice" required  lay-verify="required" placeholder="请输入商品价格" autocomplete="off" class="layui-input">
    </div>
    </div>
    ...
    <div class="layui-input-block">
      <input type="text" name="goodsNum" required  lay-verify="required" placeholder="请输入商品库存" autocomplete="off" class="layui-input">
    </div>
    </div>
